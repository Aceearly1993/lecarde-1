...
`FIXED` - A bug in the invincibility potion timer system so that the invincibility potion timer will no longer be reset after another item crash.  (Aceearly1993)  
